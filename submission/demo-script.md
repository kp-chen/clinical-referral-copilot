...
| 00:54–01:07 | Evaluation | The evaluation view separates evidence from persuasion. This tiny synthetic gold set is explicitly illustrative: four urgency labels agree, while one disagreement remains visible for review. |
| 01:07–01:22 | Safety case / blocked input | Identifiers and high-confidence prompt-injection patterns are blocked before any model call. Evidence appears only when every quoted phrase exists in the supplied narrative. |
