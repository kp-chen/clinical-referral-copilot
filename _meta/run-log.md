...
- Submission artifacts: 1280×720 thumbnail destination-verified; 97-second 1920×1080 H.264/AAC final demo rebuilt with live-model scenes and OpenAI `gpt-4o-mini-tts` Cedar narration, then destination-verified (SHA-256 `8DDEE99F9B17E217AFCEEEA017EBD58806B29EA9C07D414F44AE0A8BC1FA03E1`). The seven narration segments exactly match their 8/15/19/12/13/15/15-second scene windows. Pitch-preserving timing adjustment produced 1.002 seconds of audible silence between segments 1 and 2, then 2.001–2.003 seconds at every later boundary. Burned captions use a dark navy backing; the previously illegible white-on-white frame at 00:12 was reproduced before the change and visually verified after it. Publication copy discloses that the voice is AI-generated.
